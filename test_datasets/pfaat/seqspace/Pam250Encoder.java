...
/**
 * SeqSpaceEncoder implementation for a Pam250-based encoding.
 *
 * @author $Author: xih $
 * @version $Revision: 1.2 $, $Date: 2002/10/11 18:30:38 $ */
public class Pam250Encoder implements SeqSpaceEncoder {
    // PAM250 matrix
    ...
    public double getPairScore(AminoAcid aa1, AminoAcid aa2) {
        return PAM250[aa1.getIndex()][aa2.getIndex()];
    }
}
