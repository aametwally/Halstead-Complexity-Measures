...
/**
 * SeqSpaceEncoder implementation for a Blosum50-based encoding.
 *
 * @author $Author: xih $
 * @version $Revision: 1.2 $,  $Date: 2002/10/11 18:30:38 $ */
public class Blosum50Encoder implements SeqSpaceEncoder {
    // BLOSUM50 matrix
    ...
    public double getPairScore(AminoAcid aa1, AminoAcid aa2) {
        return BLOSUM50[aa1.getIndex()][aa2.getIndex()];
    }
}
